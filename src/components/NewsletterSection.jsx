    ...
    <section className="bg-white py-20 md:py-16 px-6 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          className="rounded-3xl p-10 sm:p-16 bg-[#F7F3ED] border border-[#E8E1D8] shadow-sm"
        >
              ...
              <AnimatePresence mode="wait">
                ...
                {!subscribed ? (
                  ...
                  >
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      ...
                      <motion.input
                        ...
                        className="flex-1 px-6 py-4 rounded-2xl bg-white border border-gray-300 text-[#0E2038] placeholder-gray-400 focus:outline-none focus:border-[#0E2038] transition duration-300"
                      />
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        type="submit"
                        className="px-8 py-4 rounded-2xl bg-[#0E2038] text-white text-sm transition duration-300 hover:bg-[#1A3354]"
                      >
                        Subscribe
                      </motion.button>
                  ...
                  <motion.div
                    ...
                    exit={{ opacity: 0 }}
                    transition={{ duration: 0.5 }}
                    className="flex flex-col items-center justify-center bg-white rounded-3xl p-12 text-center border border-gray-200"
                  >
                    ...
                    <motion.div
                      ...
                      className="w-16 h-16 rounded-full bg-[#0E2038]/10 flex items-center justify-center mb-6"
                    >
